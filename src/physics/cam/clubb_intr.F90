...
!---ARH
  ...
  use cam_history_support, only: fillvalue, max_fieldname_len ! do we need fillvalue? BAS
...
!=======
  ...
  !-------------------------------------------------------------------------------
   ...
   use wv_saturation,   only: qsat  !BAS
   use interpolate_data,only: vertinterp   !BAS
