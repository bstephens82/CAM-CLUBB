...
subroutine clubb_init_cnst(name, latvals, lonvals, mask, q)
  ...
  subroutine clubb_readnl(nlfile)
   ...
   call mpi_bcast(clubb_l_use_precip_frac,    1, mpi_logical, mstrid, mpicom, ierr)
    ...
    if(clubb_C1c == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_C7c == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_C11c == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_C12 == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_C_wp2_pr_dfsn == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_C_wp3_pr_tp == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_C_wp3_pr_dfsn == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_C6rt_Lscale0 == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_C6thl_Lscale0 == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_C7_Lscale0 == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_c_K == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_nu1 == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_c_K6 == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_nu6 == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_nu8 == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_nu10 == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_c_K_hm == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_c_K_hmb == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_K_hm_min_coef == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_nu_hm == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_slope_coef_spread_DG_means_w == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_pdf_component_stdev_factor_w == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_coef_spread_DG_means_rt == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_coef_spread_DG_means_thl == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_gamma_coefc == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_mu == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_omicron == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_zeta_vrnce_rat == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_upsilon_precip_frac_rat == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_taumin == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_taumax == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_Lscale_mu_coef == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_Lscale_pert_coef == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_alpha_corr == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_thlp2_rad_coef == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_thlp2_rad_cloud_frac_thresh == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_C_invrs_tau_wpxp_Ri == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_C_invrs_tau_wpxp_N2_thresh == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_xp3_coef_base == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_xp3_coef_slope == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_altitude_threshold == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_rtp2_clip_coef == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_Cx_min == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
    if(clubb_Cx_max == unset_r8) call endrun(sub//": FATAL: clubb_c1 is not set")
