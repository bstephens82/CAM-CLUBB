...
!$omp   itau_zt, iinvrs_tau_zt, iKh_zt, iwp2thvp, iwp2rcp, iw_up_in_cloud, iw_down_in_cloud, &
!$omp   icld_updr_frac, icld_downdr_frac, iwprtpthlp, irc_coef, isigma_sqd_w_zt, irho )
