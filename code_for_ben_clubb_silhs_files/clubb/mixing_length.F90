...
!--------------------------------------------------------------------------------------------------
    ...
    do k = 1, nz
      do i = 1, ngrdcol
        ...
        invrs_tau_wp2_zm(i,k) = invrs_tau_no_N2_zm(i,k) + C_invrs_tau_N2 * brunt_freq_pos(i,k) + &
    ...
    if ( l_e3sm_config ) then
      ...
      do k = 1, nz
        do i = 1, ngrdcol
          invrs_tau_xp2_zm(i,k) = invrs_tau_no_N2_zm(i,k) + C_invrs_tau_N2 * brunt_freq_pos(i,k) + &
